...
--LayoutHook
myLayoutHook  =  onWorkspace "1:web" webL $ onWorkspace "2:code" codeL $ onWorkspace "3:gvim" codeL $ onWorkspace "9:gimp" gimpL $ onWorkspace "6:virtual" fullL $ onWorkspace "7:chat" imLayout $ onWorkspace "8:media" fullL $ standardLayouts 
   where
    ...
    imLayout = avoidStruts $ smartBorders $ withIM ratio pidginRoster $ reflectHoriz $ withIM skypeRatio skypeRoster (tiled ||| reflectTiled ||| Grid) where
        ...
        ratio = (1%9)
        skypeRatio = (1%8)
        pidginRoster    = And (ClassName "Empathy") (Role "contact_list")
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((modMask,  xK_d ), spawn "/home/bl/bin/bookpd")
